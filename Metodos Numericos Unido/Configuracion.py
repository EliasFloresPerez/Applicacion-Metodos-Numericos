...
class Metodo_Taylor(ttk.Frame):
    ...
    def Crear_Label(self):
        ...
        labelIB = ttk.Label(self, text ="Iteraciones   :",font =  self.Er.Letra3, width = 15 ).place(x = 20, y=186) 
    ...
    def Crear_Entry(self):
        ...
        self.x0 = Entry(self,text="",fg="black",bg="white",width = 10 ,font= self.Er.Letra3 ,justify='center')
        self.x0.place(x = 120, y = 146)

        self.CantidadPasos = Entry(self,text="",fg="black",bg="white",width = 10 ,font= self.Er.Letra3 ,justify='center')
        self.CantidadPasos.place(x = 120, y = 186)
...
class Acerca_de(ttk.Frame):
    ...
    def Crear_Botones(self):
        self.GitHub = ttk.Button(self, text="Github", width = 15, command= self.Github)
        self.GitHub.place(x =160, y = 270)
        self.Youtube = ttk.Button(self, text="Video", width = 15, command= self.Youtube)
        self.Youtube.place(x = 340, y = 270)
    ...
    def Stiker_Pollo(self):
        ...
        self.BotonPollo = Button(self, text = '1', image =self.pollite,background = self.Er.Fondo ,command = self.Piar,borderwidth = 0)
        imagen_p = self.BotonPollo
        self.BotonPollo.place(x=570,y = 510)
    
    def Github(self):
        webbrowser.open("https://github.com/EliasFloresPerez/Applicacion-Metodos-Numericos")

    def Youtube(self):
        webbrowser.open("https://youtu.be/mPQse_LWbIk")
